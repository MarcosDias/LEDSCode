...
public class DomainFactory {
  ...
  public static CharSequence serviceBlock() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("findLibraryByName => Media.MediaRepository.findMediaByCharacter");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("findMediaByName => LibraryEntity.LibraryRepository.findLibraryByName");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("findPersonByName => LibraryEntity.LibraryRepository.findLibraryByName");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder;
