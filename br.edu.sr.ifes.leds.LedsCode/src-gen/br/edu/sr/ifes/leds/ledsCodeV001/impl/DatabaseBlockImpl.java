 ...
 * <ul>
 *   <li>{@link br.edu.sr.ifes.leds.ledsCodeV001.impl.DatabaseBlockImpl#getVersionValue <em>Version Value</em>}</li>
 *   <li>{@link br.edu.sr.ifes.leds.ledsCodeV001.impl.DatabaseBlockImpl#getNameValue <em>Name Value</em>}</li>
 *   <li>{@link br.edu.sr.ifes.leds.ledsCodeV001.impl.DatabaseBlockImpl#getUserValue <em>User Value</em>}</li>
 *   <li>{@link br.edu.sr.ifes.leds.ledsCodeV001.impl.DatabaseBlockImpl#getPassValue <em>Pass Value</em>}</li>
 *   <li>{@link br.edu.sr.ifes.leds.ledsCodeV001.impl.DatabaseBlockImpl#getHostValue <em>Host Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseBlockImpl extends MinimalEObjectImpl.Container implements DatabaseBlock
{
  ...
  {
    return LedsCodeV001Package.Literals.DATABASE_BLOCK;
  }
  ...
  public void setVersionValue(String newVersionValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LedsCodeV001Package.DATABASE_BLOCK__VERSION_VALUE, oldVersionValue, versionValue));
  }
  ...
  public void setNameValue(String newNameValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LedsCodeV001Package.DATABASE_BLOCK__NAME_VALUE, oldNameValue, nameValue));
  }
  ...
  public void setUserValue(String newUserValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LedsCodeV001Package.DATABASE_BLOCK__USER_VALUE, oldUserValue, userValue));
  }
  ...
  public void setPassValue(String newPassValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LedsCodeV001Package.DATABASE_BLOCK__PASS_VALUE, oldPassValue, passValue));
  }
  ...
  public void setHostValue(String newHostValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LedsCodeV001Package.DATABASE_BLOCK__HOST_VALUE, oldHostValue, hostValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LedsCodeV001Package.DATABASE_BLOCK__VERSION_VALUE:
        return getVersionValue();
      case LedsCodeV001Package.DATABASE_BLOCK__NAME_VALUE:
        return getNameValue();
      case LedsCodeV001Package.DATABASE_BLOCK__USER_VALUE:
        return getUserValue();
      case LedsCodeV001Package.DATABASE_BLOCK__PASS_VALUE:
        return getPassValue();
      case LedsCodeV001Package.DATABASE_BLOCK__HOST_VALUE:
        return getHostValue();
    }
